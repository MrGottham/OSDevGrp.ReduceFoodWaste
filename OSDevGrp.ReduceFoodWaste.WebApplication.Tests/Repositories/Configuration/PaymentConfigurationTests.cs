...
namespace OSDevGrp.ReduceFoodWaste.WebApplication.Tests.Repositories.Configuration
{
    ...
    public class PaymentConfigurationTests : TestBase
    {
        ...
        public void TestThatConstructorInitializePaymentConfiguration()
        {
            ...
            Assert.That(paymentHandlerElementForPayPal.ActionName, Is.Not.Null);
            Assert.That(paymentHandlerElementForPayPal.ActionName, Is.Not.Empty);
            Assert.That(paymentHandlerElementForPayPal.ActionName, Is.EqualTo("PayWithPaypal"));
